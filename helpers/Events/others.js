...
export default async function on({ cht, Exp, store, ev, is }) {
    ...
    ev.on({ 
        ...
        if(cfg?.menu_type == "text"){
          ...
          menu.image = fs.readFileSync(fol[3] + "liuz.jpg")
          menu.caption = text
          Exp.sendMessage(id, menu, { quoted: cht })
          ...
          Exp.relayMessage(cht.id, {
           "orderMessage": {
             ...
             "ItemCount": 0,
             "message": text,
             "sellerJid": "6282245186794@s.whatsapp.net",
             "token": "AR6oiV5cQjZsGfjvfDwl0DXfnAE+OPRkWAQtFDaB9wxPlQ==",
             "thumbnail": (await fs.readFileSync(fol[3] + "liuz.jpg")).toString("base64"),
           }
         },{})
        } else {
          menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnail: fs.readFileSync(fol[3] + "liuz.jpg"),
                    sourceUrl: "https://github.com/JustLiuzz/ZettaAi",
                    mediaUrl: `https://wa.me/6282245186794/${Math.floor(Math.random() * 100000000000000000)}`,
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: "6282245186794@newsletter",
                    serverMessageId: 152
                }
            }
          }
